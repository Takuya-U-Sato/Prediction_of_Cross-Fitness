...
int main(int argc, char* argv[])
{
    ...
    ofstream outputfile_fitness("./Np_" + to_string(cg.Rank_lowdim) + "_" + to_string(cg.alpha) + "_" + to_string(cg.random_seed_genotype) + "/Base_fitness_" + to_string(cg.random_seed_antibiotics) + "_.csv");
